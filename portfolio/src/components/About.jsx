        ...
        <div className="about">
            <div className='about-text'>
                ...
                <p className="professional-summary">
                    ...
                    <br />
                    <br />
                    I am worked as a <span className='highlight'> Frontend Developer </span> in an early stage startup - <a href=""> Dustid </a>. In my work here I focused on maintaining and modernising existing systems and contributing to the developement of new systems.
                    <br />
                    <br />
